...
from torch_geometric.nn import GCNConv, APPNP, GATConv, SAGEConv
...
class GCN(torch.nn.Module):
    def __init__(self, num_node_features, num_classes, hidden_dimensions=64, dropout=0, bias=True):
        super().__init__()
        self.conv1 = GCNConv(num_node_features, hidden_dimensions, cached=True, bias=bias)
